          ...
          <div className="header__container">
            ...
            <nav className={`header__nav ${showMenu ? "show-menu" : ""}`}>
              <ul className="header__menu">
                <li className="header__link"><a href="#" className="link">Favorite coffee</a></li>
                <li className="header__link"><a href="#" className="link">About</a></li>
                <li className="header__link"><a href="#" className="link">Mobile app</a></li>
                <li className="header__link"><a href="#" className="link">Contact us</a></li>
              </ul>
            </nav>
        ...
        <div className="container footer__container">
          <div className="footer__contact">
            <div className="footer__content">
              <h2 className="title footer__title">Sip, Savor, Smile. 
                <span className="italic"> It’s coffee time!</span>
                </h2>
            ...
            <div className="contact__info">
              <h3 className="info__title subtitle">Contact us</h3>
              <div className="container__info">
                <div className="info__box info__link">
                  <a href="https://maps.app.goo.gl/4Xc2W6JG3ggZ8hbcA" 
                  target="_blank" 
                  className="info">
                    <svg xmlns="http://www.w3.org/2000/svg" 
                    width="20" 
